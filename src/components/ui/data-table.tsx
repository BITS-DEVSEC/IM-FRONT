      ...
      <div className="flex items-center justify-between py-4">
        <div className="flex items-center gap-2 flex-1">
          ...
          <Input
            ...
            value={(table.getColumn("coverageType")?.getFilterValue() as string) ?? ""}
            onChange={(event) =>
              table.getColumn("coverageType")?.setFilterValue(event.target.value)
            }
            className="max-w-sm h-10" // Ensure consistent height with button
          />
        </div>
        <DropdownMenu>
