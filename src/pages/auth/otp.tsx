      ...
      <main className="min-h-screen flex flex-col justify-center overflow-hidden">
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-24">
          <div className="flex justify-center">
            <div className="w-full max-w-md mx-auto text-center  px-4 sm:px-8 py-10 rounded-xl  ">
              {/* Progress Bar */}
              <div className="flex justify-center mb-8 ml-13">
                <ol className="flex items-center w-3/4 align-middle">
                  ...
                  <li className="flex w-full items-center after:content-[''] after:w-full after:h-0.5 after:border-b after:border-2 after:inline-block after:border-gray-300">
                    <span className="text-white flex items-center justify-center w-6 h-6 rounded-full lg:h-8 lg:w-8 shrink-0 bg-gray-300  dark:bg-yellow-600  text-gray-600 bg-yellow-800">
                      2
                    </span>
                  </li>
              ...
              <form id="otp-form">
                ...
                <div className="max-w-[200px] md:max-w-[260px] mx-auto mt-4">
                  <a
                    ...
                    className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-yellow-800 dark:bg-yellow-600 px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-yellow-700 focus:outline-none focus:ring focus:ring-indigo-300 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150"
                  >
                    Next
                  </a>
                </div>
              ...
              <div className="text-sm text-slate-500 mt-4">
                Didn't receive code?{" "}
                <a
                  className="font-medium text-yellow-950 dark:text-yellow-600 hover:text-indigo-600"
                  href="#0"
                >
                  Resend
                </a>
