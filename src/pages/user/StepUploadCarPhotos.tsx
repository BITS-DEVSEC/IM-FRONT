      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {["front", "back", "left", "right"].map((angle) => (
          <div key={angle} className="space-y-2">
            <Label htmlFor={`photo-${angle}`} className="capitalize">
              {angle} view
            </Label>
            <div className="flex gap-4">
              <div className="w-1/2">
                <Input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    handleFileChange(angle, e.target.files?.[0] || null)
                  }
